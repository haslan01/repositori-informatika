            ...
            <div class="card-body">
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        <label for="nis">Nomor Induk Mahasiswa</label>
                        <input type="text" name="nis" id="nis" placeholder="Nomor Induk Mahasiswa" autocomplete="off" value="<?= set_value('nis') ?>" class="form-control
                        ...
                        <?php if (isset($validation)) { ?>
                            ...
                            <?php } ?>
                        <?php } else { ?>
                            <small class="form-text text-muted">Masukkan Nomor Induk Mahasiswa dengan benar</small>
                        <?php } ?>
                    </div>
                    ...
                    <div class="form-group form-check">
                        ...
                        <label class="form-check-label show-password" for="show-password"> <i class="mdi mdi-eye-outline"></i> Show Password</label>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col">
