        ...
        <div class="card-body">
            <form
                ...
                <div class="form-group">
                    <p>
                        ...
                        <button
                            ...
                            data-target="#collapseUploadFoto"
                            aria-expanded="false"
                            aria-controls="collapseUploadFoto">
                            Upload Foto Siswa
                        </button>
                        <?php if (isset($validation)) { ?>
                    ...
                    <div class="collapse" id="collapseUploadFoto">
                        ...
                        <div class="form-group">
                            <input
                                type="file"
                                class="custom-file-input fas dropify"
                                data-height="150"
                                name="foto"
                                id="foto">
                        </div>
                ...
                <div class="form-group form-check">
                    <input
                        type="checkbox"
                        class="form-check-input show-password no-check"
                        id="show-password">
